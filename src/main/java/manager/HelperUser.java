...
public class HelperUser extends HelperBase {
    ...
    public void initLogin() {
        pause(2000);
        if (isHomePage()) click(By.cssSelector("a[href='/login']"));
    }
    ...
    public void login(User user) {
        ...
        fillLoginForm(user);
        submitLogin();
        new WebDriverWait(wd, 5).until(ExpectedConditions.visibilityOf(wd.findElement(By.cssSelector("button[data-testid='header-member-menu-button']"))));
    }
    ...
    public void navigateToAtlassianProfile() {
        ...
        new WebDriverWait(wd, 5).until(ExpectedConditions.titleIs("Atlassian account"));
